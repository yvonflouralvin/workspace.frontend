...
| `business-firm-missions` | 3021 | **Business Firm Mission** (backend `business_firm_missions`, port 5000) — surface unifiée pour le suivi des missions et prestations d'un cabinet pour ses clients : **Clients** (lit/écrit directement `tiers`, étendu de secteur d'activité/contrats/services souscrits/échanges/actions réalisées — aucun registre client dupliqué), **Missions** (lit/écrit directement `projects`, étendu de type_mission/departement — le suivi détaillé tâches/sous-tâches/jalons reste dans Workspace), **Audit** (domaine neuf et indépendant du service `audit_missions`, qui porte une offre distincte vendue aux clients — missions, équipe, planning, documents demandés/reçus/manquants, checklist à 5 statuts, risques distincts des anomalies, rapports provisoire/final, historique), **Assistance fiscale** (domaine neuf — dossiers, obligations, échéances avec alerte sur l'accueil du module, déclarations, correspondances, paiements, pénalités, contrôles fiscaux). | — |
