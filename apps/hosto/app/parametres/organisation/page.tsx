...
import { getParametre, updateParametre } from "@/app/lib/api";
      ...
      <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-body-sm text-on-surface-variant mt-1">
            Identité de votre établissement. Ces informations sont reprises en en-tête des documents
            générés (ordonnances, rapports, comptes rendus…) : logo et coordonnées.
          </p>
        </div>
        ...
        {canManage && !loading && (
          ...
          >
            ...
            <div>
              ...
              <input className={inputCls} value={form.denomination} onChange={(e) => set("denomination", e.target.value)} placeholder="Nom de l'établissement (clinique, hôpital…)" />
            </div>
            <div>
